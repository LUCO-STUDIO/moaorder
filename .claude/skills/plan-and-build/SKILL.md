---
name: plan-and-build
description: Read project docs, discuss open questions, create phased implementation plans and tasks from prompts/task-create.md, run phases with scripts/run-phases.py, and notify the user of outcomes.
metadata:
  short-description: Turn project docs into phased implementation tasks and execution
